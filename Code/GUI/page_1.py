...
file_name1 = "..\\..\\Data\\clust&Dealias\\hp1\\hp1_characters.pkl"
file_name2 = "..\\..\\Data\\embedRelations\\hp1\\hp1_relations2.pkl"
file_name3 = "..\\..\\Data\\embedRelations\\hp1\\hp1_relations1.pkl"
# file_name3 = "..\\..\\Data\\embedRelations\\hp1\\hp1_few_char_sentences.pkl"
if not os.path.isfile(file_name1) or not os.path.isfile(file_name2) or not os.path.isfile(file_name3):
    logging.info('First run test_relations_clustering.py to create the dataset.')
    exit(-1)

characters = pd.read_pickle(file_name1)
two_chars_relations = pd.read_pickle(file_name2)
two_chars_relations = two_chars_relations.sort_values('Label-verb')
one_char_relations = pd.read_pickle(file_name3)
one_char_relations = one_char_relations.sort_values('Label-verb')
...
graph = create_graph(characters, two_chars_relations)
